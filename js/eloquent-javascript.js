...
export function printNums(...numbers) {
  numbers.forEach((n) => {
    console.log(n)
  })
}
...
export function range(start, end, st) {
  let r = []
  let s = st
  if (s == undefined) {
    s = 1
...
export function sum(rangeArray) {
  let s = 0
...
export function prepend(val, list) {
  if (list == undefined) {
...
export function arrayToList(valuesArray) {
...
export function arrayToListToArray() {
...
export function deepEqual(param1, param2) {
